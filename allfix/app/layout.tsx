...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type:        'website', locale: 'en_KE', url: SITE_URL, siteName: 'Smartech Kenya',
  },
  twitter: { card: 'summary_large_image', title: 'Smartech Kenya', description: 'Genuine electronics and home appliances. Fast Nairobi delivery.' },
      ...
      <body className="font-sans bg-cream text-ink">
        <Providers>
          ...
          <Toaster
            ...
            toastOptions={{
              duration: 3000,
              style: { background: '#0C0C0C', color: '#F5F0E8', borderRadius: '14px', fontSize: '13px', padding: '12px 18px' },
            }}
          />
        </Providers>
      </body>
