    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center px-4 py-20">
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8 text-center">
          ...
          <h1 className="font-semibold text-gray-900 text-2xl font-light mb-2">Reset Password</h1>
          ...
          <div className="space-y-3">
            <a href="https://wa.me/254746722417?text=Hi%20Smartech%20Kenya%2C%20I%20need%20to%20reset%20my%20account%20password.%20My%20email%20is%3A%20"
              ...
              className="flex items-center justify-center gap-2.5 w-full py-3.5 rounded-xl bg-blue-800 text-white text-sm font-semibold hover:bg-gray-800 transition-all">
            ...
            <a href="mailto:smartechkenya01@gmail.com?subject=Password%20Reset%20Request&body=Hi%20Smartech%20Kenya%2C%0A%0AI%20need%20to%20reset%20my%20password.%20My%20account%20email%20is%3A%20"
              className="flex items-center justify-center gap-2.5 w-full py-3.5 rounded-xl border border-gray-200 text-gray-900 text-sm font-medium hover:bg-gray-100 transition-colors">
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          <Link href="/login" className="text-gray-900 font-semibold hover:underline">Back to Sign in</Link>
        </p>
      </div>
    </div>
  );
