    ...
    <>
      ...
      <section className="relative h-[600px] bg-gradient-to-br from-primary-50 to-primary-100">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-accent-200 rounded-full opacity-30 animate-pulse animation-delay-400" />
        </div>
        ...
        <div className="relative container-custom h-full flex items-center">
          <div className="max-w-2xl animate-slide-up">
            ...
            <p className="text-xl text-neutral-700 mb-8">
              Discover top-quality tech and kitchen appliances from trusted brands. 
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link href="/products?category=tech" className="btn-outline text-center">
                Browse Tech
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="relative h-full flex flex-col items-center justify-center text-white p-8">
                ...
                <h3 className="text-3xl font-display font-bold mb-2">Tech Appliances</h3>
                <p className="text-lg text-center">Laptops, Phones, Tablets & More</p>
              </div>
            </Link>
            ...
            >
              ...
              <div className="relative h-full flex flex-col items-center justify-center text-white p-8">
                ...
                <h3 className="text-3xl font-display font-bold mb-2">Kitchen Appliances</h3>
                <p className="text-lg text-center">Fridges, Blenders, Microwaves & More</p>
              </div>
            </Link>
          </div>
        </div>
